...
const Header = ({ openChangeLanguageModal }) => {
  ...
  return (
    ...
    //   className={`${
    //     scroll
    //       ? "bg-white/50 backdrop-blur-lg shadow-lg shadow-[0_2px_5px_rgba(0,0,0,0.1)] border-b border-gray-200"
    //       : "bg-transparent backdrop-blur-lg"
    //   } fixed left-0 top-0 z-40 flex w-full items-center justify-between py-4 lg:py-5 xl:h-[78px] xl:justify-between xl:px-10 2xl:px-10`}
    // >
    //    <h2
    ...
    //       <ul className="text-neutral-900 lg:gap-x-5 xl:flex xl:gap-x-5 2xl:gap-x-5">
